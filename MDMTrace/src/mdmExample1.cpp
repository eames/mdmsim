...
int main(int argc, char* argv[]) 
{
	...
	//Create a new Tfile, TTree and TBranches
        TFile* Example_mdm = new TFile("results_Example.root","RECREATE");
        TTree* tree = new TTree("mdm_results_Example","Results_Example");
	...
	vector<float> wire_zPos = {2,17.1,33.4,49.7};
        ...
        tree->Branch("ang", &ang,"ang/F");
	tree->Branch("initial_angle", &initial_angle,"initial_angle/F");
	...
	// create new branch with x and z pos
